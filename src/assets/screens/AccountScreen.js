...
const AccountScreen = () => {
  ...
  const navItems = [
    { label: 'Home', icon: require('../images/home-icon.png'), route: 'Home' },
    ...
    { label: 'Account', icon: require('../images/accountblue-icon.png'), route: 'Account' },
  ];
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.optionsList}>
        ...
        <TouchableOpacity style={styles.optionItem} onPress={() => handlePressOtherOption('Đổi mật khẩu')}>
          <View style={styles.optionIconContainer}>
            <Image
              source={require('../images/unlock_icon.png')}
              style={styles.optionIcon}
            />
          </View>
        ...
        <TouchableOpacity style={styles.optionItem} onPress={() => handlePressOtherOption('Liên hệ/Hỗ trợ')}>
          <View style={styles.optionIconContainer}>
            <Image
              source={require('../images/support_icon.png')}
              style={styles.optionIcon}
            />
          </View>
